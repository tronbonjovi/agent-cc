  ...
  return (
    <>
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        {/* Type filter pills */}
        <div className="flex items-center gap-1 px-3 py-1.5 border-b border-border bg-gradient-to-r from-[hsl(var(--primary)/0.03)] to-transparent">
          <button
        ...
        {/* Footer */}
        {results.length > 0 && (
          <div className="border-t border-border px-4 py-2 text-[11px] text-muted-foreground flex items-center justify-between bg-gradient-to-r from-transparent to-[hsl(var(--primary)/0.03)]">
