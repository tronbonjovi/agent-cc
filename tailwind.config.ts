  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        entity: {
          project: "hsl(var(--entity-project) / <alpha-value>)",
          mcp: "hsl(var(--entity-mcp) / <alpha-value>)",
          plugin: "hsl(var(--entity-plugin) / <alpha-value>)",
          skill: "hsl(var(--entity-skill) / <alpha-value>)",
      ...
      keyframes: {
        ...
        "pulse-ring": {
          ...
          "70%": { boxShadow: "0 0 0 4px transparent" },
      ...
      boxShadow: {
        ...
        "glow-lg": "0 0 20px var(--glow-blue)",
        "glow-green": "0 0 12px var(--glow-green)",
        "glow-purple": "0 0 12px var(--glow-purple)",
